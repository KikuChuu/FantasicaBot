...
Init_globals()
{
	...
	TRNECT_HOSHI_IMAGE := "FANTASICA IMAGES\Event\UnderTheStarrySkies\Training\imagehoshi-" . width . "_" . height . ".png"
	TRNECT_PIXIS_IMAGE := "FANTASICA IMAGES\Event\UnderTheStarrySkies\Training\imagepixis-" . width . "_" . height . ".png"
