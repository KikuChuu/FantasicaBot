...
bestQuestPlacementPoints := new BestQuestPlacementPoints(questPlacementPoints)
questMenuBot := new QuestMenuBot(generalConfiguration, questConfiguration, deploymentConfiguration, detector, controller, bestQuestPlacementPoints)
...
questPlacementBot := new QuestPlacementBot(deploymentConfiguration, detector, controller, questPlacementPoints, bestQuestPlacementPoints)
questResultsBot := new QuestResultsBot(detector, controller, bestQuestPlacementPoints)
